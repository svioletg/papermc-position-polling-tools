...
function warnOnLatestVersion() {
  ...
  warning.innerHTML = "<p class='first admonition-title'>Note</p> " +
    "<p class='last'> " +
    "This document is for an <strong>unreleased development version</strong> and its contents are subject to change" +
    "often. <a href='/en/stable/'>Click here</a> to see documentation for the latest stable version." +
    "</p>";
